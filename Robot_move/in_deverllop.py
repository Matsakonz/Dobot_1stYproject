...
device.move_to(sound[0], sound[1]+100, sound[3]+30)
device.move_to(sound[0], sound[1]-100, sound[3]+50)
device.move_to(sound[0], sound[1]+150, sound[3]+20)
device.move_to(sound[0], sound[1]-150, sound[3]+0)
device.move_to(sound[0], sound[1]+60, sound[3]-40)
device.move_to(sound[0], sound[1]-60, sound[3]-10)
device.move_to(sound[0], sound[1], sound[3])
